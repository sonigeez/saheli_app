...
class RecommedndePlacesScreen extends StatefulWidget {
  const RecommedndePlacesScreen({super.key, required this.channel});
  final Channel channel;

  @override
  State<RecommedndePlacesScreen> createState() => _RecommedndePlacesScreenState();
}
...
class _RecommedndePlacesScreenState extends State<RecommedndePlacesScreen> {
  ...
  _sendMessageToChannel(String link) async {
    await widget.channel.sendMessage(Message(text: link));
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: FutureBuilder<GoogleNearbyAPIModel?>(
          future: GoogleMapAPIManager().getNearbyPlaces(context.read<HomeScreenProvider>().currentLocation!),
                    ...
                    children: [
                      ListTile(
                        ...
                        onTap: () async {
                          ...
                          await _sendMessageToChannel(encodedURl);
                          context.popRoute();
                        },
