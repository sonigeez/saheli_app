            ...
            children: <Widget>[
              ...
              Form(
                ...
                child: Padding(
                  ...
                  child: PinCodeTextField(
                    ...
                    obscureText: true,
                    obscuringCharacter: '*',
                    obscuringWidget: const ColoredBox(
                      color: Colors.blue,
                      child: SizedBox(
                        height: 25,
                        width: 25,
              ...
              Row(
                ...
                children: [
                  ...
                  TextButton(
                    onPressed: () => context.read<UserNotifier>().sendLoginOtp(widget.phoneNumber!),
                    child: const Text(
                      "RESEND",
                      style: TextStyle(
                  ...
                  child: TextButton(
                    onPressed: () async {
                      if (formKey.currentState!.validate()) {
                        ...
                        final x = await AuthServices.verifyOtp(
                          currentText,
                          widget.phoneNumber!,
                        );
                        debugPrint("we hit here");
                        if (x == null) {
